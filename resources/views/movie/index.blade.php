...
<form action="{{ route('movie.index') }}" class="mb-3">
    <div class="input-group">
        <input type="text" name="search" id="txt-search" class="m-2 input-group-text input-group-prepend" value="@if(isset($search)){{$search}}@endif" placeholder="キーワードを入力"></input>
